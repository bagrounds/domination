...
• Defines a new type 'Actions' to represent game actions.
• Installs various type class instances for common data structures and protocols.
• ISOs:
• Converts between 'Actions' and 'Int'
• 'Hashable', 'Semiring', 'Ring', and other classes related to numbers
-}
