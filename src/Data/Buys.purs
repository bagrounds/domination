...
• Defines a data type and associated functions for working with wire int values.
• Provides instances for common data structures, such as arrays and JSON encoding/decoding.
• Offers lens and show functionality for the new data type.
-}
