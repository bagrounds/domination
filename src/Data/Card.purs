...
• Defines a data type and functions for working with cards in the game.
• Includes definitions for different types of cards, lenses for accessing card properties, and utility functions.
