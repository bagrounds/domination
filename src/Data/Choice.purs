...
• Defines various types of choices in the game.
• Includes functions for evaluating and working with choices.
Key Choices:
- Conditional choice (If)
- Multi-choice sequence (And, Or, PickN, Option)
- Move between piles (MoveFromTo)
- Gain cards or actions (GainCard, GainCards, GainActions, GainBuys)
- Discard cards (Discard)
- Draw a card
- Gain bonus
- Stack evaluation (StackChoice)
Evaluation Functions:
• `isAttack` checks if a choice is an attack.
-}
