...
• Represents the ID of a pile in the Domination game.
• Provides instances for JSON encoding and decoding, bounded enumeration, hashing, and utilities.
Key features:
• Bounded range (from 0 to top)
• Enumerated type with successor and predecessor functions
• Hashable instance for efficient data storage
-}
