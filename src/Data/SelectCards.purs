...
• Data type for card selection operations in a card game.
• Represents different ways of selecting cards (e.g. all available cards).
• Implements standard type class instances:
• Equality comparison
