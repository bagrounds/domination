...
• Defines a data structure for representing functions as stacks of pairs.
• Provides various category and monoidal product instances.
Example uses:
• Applying a function to two values by extracting them from the top pair on the stack.
• Composing and duplicating the same function in various ways.
-}
