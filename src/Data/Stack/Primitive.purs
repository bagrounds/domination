...
• Provides basic stack operations and types for computing.
• Includes primitives for swapping, duplicating, adding, multiplying, subtracting, dividing, and other categorical structures.
• Supports generic JSON encoding and decoding, as well as ArrayBuffer operations.
StackPrimitive typeclass:
- Cocartesian
- Cartesian
- BraidedCategory
-}
