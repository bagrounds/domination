...
• Defines a data type Var with two variants: Unbound and Bound.
• Provides instances for various type classes, including:
• Generic, Eq, Functor, Show, EncodeJson, DecodeJson, DynamicByteLength, and EncodeArrayBuffer.
-}
