...
• Module summary:
• Defines a data type `WireBonus` representing a bonus in wire format.
• Provides an ISO for decoding and encoding bonuses from/to wire format.
• Purpose:
• Enables serializing and deserializing bonuses to/from wire format.
-}
