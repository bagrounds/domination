...
• Module purpose:
• Defines an ISO (isomorphism) to convert between a Play data structure and its wire-play representation.
• Provides functions for encoding and decoding the wire-play data structure using Argonaut.
• Derives instances of various classes, including Generic, Eq, EncodeJson, DecodeJson, Show, DynamicByteLength, and EncodeArrayBuffer.
-}
