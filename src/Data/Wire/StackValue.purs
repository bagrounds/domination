...
• Provides a set of instances and functions for encoding and decoding JSON data.
• Defines an Iso (isomorphic) type conversion between Data.StackEvaluation.StackValue and Domination.Data.Wire.StackValue.
• Includes derivation of generic and show instances, as well as encode and decode functions.
-}
