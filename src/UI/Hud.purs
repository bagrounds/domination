...
• Renders the Heads-Up Display (HUD) in a game UI.
• Displays various components, including:
• Player hand information (deck size, actions, and resources)
• Current turn state and phase
• Action phase stats (player's action value)
• Buy phase stats (player's cash and buys)
• Cleanup phase stats (player's score)
-}
