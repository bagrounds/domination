...
• Manages game configuration UI for the Domination game.
• Customizes player count, player index, game mode, kingdom card selection, and announcement settings.
• Allows players to start a new game or load a saved one.
-}
