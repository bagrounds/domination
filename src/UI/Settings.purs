{-|
Module      : Domination.UI.Settings
Description : Settings and configuration UI for the Domination game

This module provides UI components for managing game configuration:
- Player count and player index selection
- Game mode selection (short/long game)
- Kingdom card selection and randomization
- Username and announcement settings
- Game loading/saving controls
- Menu visibility management
- Version display

The settings interface allows players to customize their game experience
before starting a new game or loading a saved one.
-}
